...
\begin{tblr}{
  ...
  \midrule
  IOCL   & 80--85\% & \multicolumn{2}{c}{15--20\% combined} \\
  GAIL   & 80--85\% & \multicolumn{2}{c}{15--20\% combined} \\
  NTPC   & Rank-based shortlist & \multicolumn{2}{c}{Interview-heavy} \\
  BARC   & Qualifying only & \multicolumn{2}{c}{100\% technical interview} \\
  NPCIL  & Qualifying only & \multicolumn{2}{c}{100\% technical interview} \\
  \bottomrule
\end{tblr}
